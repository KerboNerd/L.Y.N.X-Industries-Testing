...
namespace WeaponThread {   
    partial class Weapons {
        ...
        WeaponDefinition stallionRail_def => new WeaponDefinition {

            Assignments = new ModelAssignmentsDef 
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "stallionRail",
                        AimPartId = "None",
            ...
            {
                WeaponName = "Railgun Turret RT-250 STALLION", // name of weapon in terminal
                DeviateShotAngle = 0.001f,
                AimingTolerance = 90.0f, // 0 - 180 firing angle
                ...
                Loading = new LoadingDef {
                    ...
                    HeatPerShot = 850, //heat generated per shot
                ...
                Audio = new HardPointAudioDef {
                    PreFiringSound = "",
                    FiringSound = "ArcHermesShotNormal", // WepShipGatlingShot

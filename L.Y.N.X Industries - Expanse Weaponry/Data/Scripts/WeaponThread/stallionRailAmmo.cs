...
{ // Don't edit above this line
    ...
    {
        private AmmoDef stallionRailAmmo => new AmmoDef
        {
            AmmoMagazine = "railgun70",
            AmmoRound = "railgun70round",
            HybridRound = false, //AmmoMagazine based weapon with energy cost
            EnergyCost = 10.5f, //(((EnergyCost * DefaultDamage) * ShotsPerSecond) * BarrelsPerShot) * ShotsPerBarrel
            BaseDamage = 10000f,
            ...
            {
                ModelName = "Models\\Items\\Components\\railgun35.mwm",
                ...
                Lines = new LineDef
                {
                    ...
                    Trail = new TrailDef
                    {
                        ...
                        DecayTime = 25,
                        Color = Color(red: 5.0f, green: 10.0f, blue: 50.0f, alpha: 1f),
                        Back = false,
                        CustomWidth = 0.3f,
        ...
        private AmmoDef stallionRailShrapneldef => new AmmoDef
        {
            AmmoMagazine = "",
            AmmoRound = "stallionRailShrapnel",
            HybridRound = false, //AmmoMagazine based weapon with energy cost
            ...
            {
                AmmoRound = "",
                Fragments = 0, // maybe i dunno ??? original - 0
                ForwardDegrees = 15,
                BackwardDegrees = 0,
            },
            DamageScales = new DamageScaleDef

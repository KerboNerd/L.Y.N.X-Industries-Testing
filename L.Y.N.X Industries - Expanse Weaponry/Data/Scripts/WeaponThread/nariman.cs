...
namespace WeaponThread {   
    partial class Weapons {
        ...
        WeaponDefinition nariman_def => new WeaponDefinition {
            ...
            {
                WeaponName = "Nariman PDC 70mm", // name of weapon in terminal
                ...
                Audio = new HardPointAudioDef {
                    PreFiringSound = "",
                    FiringSound = "ArcNarimanShotNormal", // WepShipGatlingShot

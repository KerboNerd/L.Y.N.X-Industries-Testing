...
namespace WeaponThread {   
    partial class Weapons {
        ...
        WeaponDefinition hermesRail1_def => new WeaponDefinition {

            Assignments = new ModelAssignmentsDef 
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "hermesRail1",
                        AimPartId = "None",
            ...
            {
                WeaponName = "Railgun Turret RT-200 HERMES", // name of weapon in terminal
